...
$islive = 'ON';
    ...
    'inline_keyboard' => [
        [
           ...
           ['text' => 'Others', 'callback_data' => 'others'], 
           ['text' => 'Buy', 'callback_data' => 'buy'], 
           // ['text' => 'Buy Now', 'url' => 'https://t.me/Tabah_Rs'], 
           ['text' => 'Finalize', 'callback_data' => 'end']
        ]
        ]];
$freecommands = urlencode("<b>
...
Note-⟩ If you get any type of bugs in this bot please inform our team at @Tabah_Rs t</b>");
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot1816615315:AAH9_Zh6dtekxEVm_b_cIACCVYML0Dp8e88/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
'inline_keyboard' => [
[['text' => "OWNER", 'url' => "https://t.me/Tabah_Rs"],]
]]);
...
// 
// Made With ♥️ By  // Made With ♥️ By @Tabah_Rs
